# Generated by Django 5.0 on 2024-03-07 12:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='friends',
            field=models.ManyToManyField(through='main_app.UserFriend', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Wishlist',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wishlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gifts', to='main_app.wishlist')),
            ],
        ),
    ]
